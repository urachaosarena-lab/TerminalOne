...
🚀 **Send the token now or select a quick token:**
  ...
  await ctx.editMessageText(message, {
    ...
    ...Markup.inlineKeyboard([
      [Markup.button.callback('$MIRA🦈', 'martingale_quick_1'), Markup.button.callback('$ORE⛏️', 'martingale_quick_2')],
      [Markup.button.callback('$zKSL💻', 'martingale_quick_3'), Markup.button.callback('$NEET👽', 'martingale_quick_4')],
      [Markup.button.callback('$TROLL😈', 'martingale_quick_5'), Markup.button.callback('$AVICI🔺', 'martingale_quick_6')],
